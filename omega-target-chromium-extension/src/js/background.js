...
(function () {
    var Log, OmegaTargetCurrent, Promise, _writeLogToLocalStorage, actionForUrl, charCodeUnderscore, dispName, drawContext, drawError, drawIcon, encodeError, external, iconCache, isHidden, options, proxyImpl, ref, ref1, refreshActivePageIfEnabled, state, storage, sync, syncStorage, tabs, timeout, unhandledPromises, unhandledPromisesId, unhandledPromisesNextId, slice = [].slice, hasProp = {}.hasOwnProperty;
