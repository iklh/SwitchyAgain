...
var OmegaPac, OmegaTarget, Promise, ProxyImpl, SettingsProxyImpl, chromeApiPromisify, extend = function (child, parent) { for (var key in parent) {
                ...
                if (profile) {
                    ...
                    profile.bypassList = (function () {
                        ...
                        for (pattern in bypassSet) {
                            if (!hasProp.call(bypassSet, pattern))
                                continue;
                            results.push({
